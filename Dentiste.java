...
public class Dentiste extends Personnel {
	...
	public Dentiste(int id_pers, String nom_pers, String prenom_pers, String cIN_pers, Date date_naissance_pers,int tele_pers, String email_pers, String adresse_pers, String position_pers, double salaire,int num_dentiste) {
